...
public class ProductsAssertionTest {
    ...
    @Test
    public void verifyTheTotalIsEqualTo51957() {
        response.body("total", equalTo(51957));
    }

    //12. Verify if the stores of limit is equal to 10
    @Test
    public void verifyStoresLimitIsEqualTo10() {
    ...
    @Test
    public void verifyProductId150115InsideCategories() {
    ...
    @Test
    public void verifyCategoriesSecondName() {
    ...
    @Test
    public void verifyTheProductIdCategories() {
